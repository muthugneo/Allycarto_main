...
class FAQ extends StatefulWidget {
  final String cat_id;
  const FAQ({Key key, this.cat_id}) : super(key: key);
...
class _FAQState extends State<FAQ> {
  ...
  Future<String> getData() async {
    try {
      final response = await http.get(Uri.parse(global.baseUrl+"faqlist?faqcatid="+widget.cat_id));

      print("aaaaaaaaaaaaaa : "+global.baseUrl+"faqlist?faqcatid="+widget.cat_id);
