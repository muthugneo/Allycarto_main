...
class ShopProductListScreen extends BaseRoute {
  ...
  ShopProductListScreen(this.screenId, this.title, this.mainCatId,
...
class _ProductListScreenState extends BaseRouteState {
  ...
  _getCatSearchedProduct(String keywordd) async {
    try {
      ...
      await apiHelper
          .getVendorproductSearchResult(page, keywordd, mainCatId.toString())
          .then((result) async {
  ...
  _getSubcategoryProduct() async {
    try {
      ...
      if (_isRecordPending) {
        ...
        await apiHelper
            .getVendorProduct(mainCatId, page, _productFilter)
            .then((result) async {
          if (result != null) {
            if (result.status == "1") {
              List<Product> _tList = result.data;
