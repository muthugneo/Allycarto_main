...
class HomeVendorListScreen extends BaseRoute {
  HomeVendorListScreen({a, o}) : super(a: a, o: o, r: 'CategoryListScreen');
  @override
...
class _CategoryListScreenState extends BaseRouteState {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Local Shops"),centerTitle: true,leading: SizedBox(),),
