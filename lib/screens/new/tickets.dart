...
class _TicketsPageState extends State<TicketsPage> {
  ...
  submitCheck() {
    ...
    } else if (_cmdController.text.length<=50) {
      showSnackBar(
          key: _scaffoldKey, snackBarMessage: "  Please enter atleast 50 character!  ");
    } else if (_imageFile1 == null) {
      showSnackBar(key: _scaffoldKey, snackBarMessage: "  Please choose image!  ");
    } else if (global.sp.getString('myPincode') == null || global.sp.getString('myPincode') == "" ){
      showSnackBar(key: _scaffoldKey, snackBarMessage: "  Please update your pincode!  ");
    } else {
      submitData();
    }
  }
  ...
  Future submitData() async {
    ...
    if (status == "200") {
      hideLoader();
      showSnackBar(key: _scaffoldKey, snackBarMessage: "  Complaint submitted successfully!  ");
      Navigator.pop(context);
    } else {
      hideLoader();
    }
