            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  global.lat = _lat;
                  global.lng = _lng;
                  global.myPincode = setPlace.postalCode;
                  global.currentLocation = "${setPlace.name}, ${setPlace.locality} ";
                  print('aaaaaaaaaaabbb ${global.lat}');
                  print('aaaaaaaaaaabbb ${global.lng}');
                  print('aaaaaaaaaaanbbb ${global.myPincode}');
                  print('aaaaaaaaaaanbbb ${global.currentLocation}');
                  // await _getNearByStore();

                  global.sp.setString("lastloc", '${global.lat}|${global.lng}');
                  global.sp.setString("myPincode", '${global.myPincode}');
                  Navigator.of(context).push(
                    MaterialPageRoute(
                        builder: (context) => BottomNavigationWidget(
                          a: widget.analytics,
