...
class ProductListScreen extends BaseRoute {
  ...
  ProductListScreen(this.screenId, this.title, this.mainCatId,
      {this.subcategoryId, a, o})
      : super(a: a, o: o, r: 'ProductListScreen');

  @override
  _ProductListScreenState createState() => new _ProductListScreenState(
      this.screenId, this.title, this.mainCatId, this.subcategoryId);
}
...
class _ProductListScreenState extends BaseRouteState {
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                if (variantIndexx) {
                                  _productList[index].selectVarient =
                                      (_productList[index].varientId)
                                          .toString();
                                }
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child:
                                                        ...
                                                        dropdownColor: global
                                                                .isDarkModeEnable
                                                            ? Theme.of(context)
                                                                .inputDecorationTheme
                                                                .fillColor
                                                            : Theme.of(context)
                                                                .scaffoldBackgroundColor, // Not necessary for Option 1
  ...
  _getData() async {
    try {
      ...
      _productFilter.maxPriceValue =
          _productList.length > 0 ? _productList[0].maxPrice : 0;
    } catch (e) {
  ...
  _getCatSearchedProduct(String keywordd) async {
    try {
      ...
      await apiHelper
          .getcatproductSearchResult(page, keywordd, subcategoryId.toString())
          .then((result) async {
      ...
      if (_isRecordPending) {
        ...
        await apiHelper
            .getSubcategoryProduct(
                subcategoryId, mainCatId, page, _productFilter)
            .then((result) async {
          if (result != null) {
            if (result.status == "1") {
              List<Product> _tList = result.data;
  ...
  Widget _productShimmer() {
    try {
      ...
      print("Exception - wishlistScreen.dart - _productShimmer():" +
          e.toString());
