            ...
            child: TextButton(
              ...
              onPressed: () {
                if (_currentIndex < 1) {
                  ...
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => LoginScreen(false, a: widget.analytics, o: widget.observer)));
                }
              },
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      _currentIndex < 1 ? "${AppLocalizations.of(context).btn_next}" : '${AppLocalizations.of(context).btn_get_started}',
