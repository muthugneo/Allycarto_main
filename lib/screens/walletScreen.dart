          ...
          Container(
            ...
            child: TextButton(
                onPressed: () async {
                 ...
                 // }  else
                 //    showSnackBar(key: _scaffoldKey, snackBarMessage: 'Please update your bank details!');
                },
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(child: SizedBox()),
                              Text(
                                "${global.appInfo.currencySign} ${_walletSpentHistoryList[index].payable_amount}",
                                style: Theme.of(context).primaryTextTheme.bodyText1,
                              )
                            ],
                          ),
