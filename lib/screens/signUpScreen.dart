...
class _SignUpScreenState extends BaseRouteState {
  ...
  var _cPin = new TextEditingController();
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onFieldSubmitted: (val) {
                            FocusScope.of(context).requestFocus(_fPin);
                          },
                        ),
                      ),
                      Text(
  ...
  _onSignUp() async {
    try {
      ...
      if (isConnected) {
        ...
        } else if (_cPin.text.isEmpty) {
          showSnackBar(
              key: _scaffoldKey, snackBarMessage: "Please enter your pincode");
