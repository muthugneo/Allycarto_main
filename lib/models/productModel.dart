...
class Product {
  ...
  String selectVarient = null;
  bool variantIndexStatus;
  bool dropdownIndexStatus = true;
  Product();
  ...
  Product.fromJson(Map<String, dynamic> json) {
    try {
      ...
      shop_name = json["shop_name"] != null ? json["shop_name"] : null;
      cat_name = json["cat_name"] != null ? json["cat_name"] : null;
      subcat_name = json["subcat_name"] != null ? json["subcat_name"] : null;
      productImage =
          json["product_image"] != null ? json["product_image"] : null;
      description = json["description"] != null ? json["description"] : null;
      product_description = json["product_description"] != null
          ? json["product_description"]
          : "";
      how_to_use = json["how_to_use"] != null ? json["how_to_use"] : "";
      benifits = json["benifits"] != null ? json["benifits"] : "";
      ratingDescription =
      ...
      price = json["price"] != null
          ...
          : null;
      mrp = json["mrp"] != null
          ? double.parse(json["mrp"].toString()).round()
          : null;
      varientImage =
      ...
      key_index = json["key_index"] != null ? json["key_index"] : null;
      isFavourite =
          json['isFavourite'] != null && json['isFavourite'] == 'false'
              ? false
              : true;
      cartQty =
      ...
      maxPrice = json['maxprice'] != null
          ? double.parse(json['maxprice'].toString()).round()
          : 0;
