  ...
  Order.fromJson(Map<String, dynamic> json) {
    try {
      totaltaxprice = json["total_tax_price"] != null
          ? double.parse(json["total_tax_price"].toString()).round()
          : 0;
      discountonmrp = json["discountonmrp"] != null
          ? double.parse(json["discountonmrp"].toString()).round()
          : 0;
      ...
      paidByWallet = json["paid_by_wallet"] != null
          ? double.parse(json["paid_by_wallet"].toString()).round()
          : 0;
      cartId = json["cart_id"] != null ? json["cart_id"] : null;
      price = json["price"] != null
          ? double.parse(json["price"].toString()).round()
          : null;
      deliveryCharge = json["delivery_charge"] != null
          ? double.parse(json["delivery_charge"].toString()).round()
          : 0;
      remPrice = json["rem_price"] != null
          ? double.parse(json["rem_price"].toString()).round()
          : null;
      couponDiscount = json["coupon_discount"] != null
          ? double.parse(json["coupon_discount"].toString()).round()
          : 0;
      ...
      subTotal = json["sub_total"] != null
          ? double.parse(json["sub_total"].toString()).round()
          : null;
      deliveryDate =
          json["delivery_date"] != null ? json["delivery_date"] : null;
      totalPrice = json["total_price"] != null
          ? double.parse(json["total_price"].toString()).round()
          : 0;
      totalProductMrp = json["total_products_mrp"] != null
          ? double.parse(json["total_products_mrp"].toString()).round()
          : 0;
      priceWithoutDelivery = json["price_without_delivery"] != null
          ? double.parse(json["price_without_delivery"].toString()).round()
          : 0;
      productList = json["data"] != null
          ? List<Product>.from(json["data"].map((x) => Product.fromJson(x)))
          : [];
      productCount = json['product_count'] != null ? json['product_count'] : 0;
      placingTime = json['placing_time'] != null
          ? DateTime.parse(json['placing_time'].toString())
          : null;
      confirmTime = json['confirm_time'] != null
          ? DateTime.parse(json['confirm_time'].toString())
          : null;
      outOfDeliveryTime = json['out_for_delivery_time'] != null
          ? DateTime.parse(json['out_for_delivery_time'].toString())
          : null;
      completedTime = json['completed_time'] != null
          ? DateTime.parse(json['completed_time'].toString())
          : null;
      cancelledTime = json['cancelled_time'] != null
          ? DateTime.parse(json['cancelled_time'].toString())
          : null;
      totalItems = json['total_items'] != null ? json['total_items'] : 0;
      orderDate = json['order_date'] != null ? json['order_date'] : null;
      esimateTime =
          json['estimated_time'] != null ? json['estimated_time'] : null;
      ...
      userLat = json['user_lat'] != null
          ? double.parse(json['user_lat'].toString())
          : null;
      userLng = json['user_lng'] != null
          ? double.parse(json['user_lng'].toString())
          : null;
    } catch (e) {
