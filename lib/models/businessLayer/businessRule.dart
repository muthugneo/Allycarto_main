...
class BusinessRule {
  ...
  inviteFriendShareMessage() {
    try {
      String shareMessage = 'Hi!\n\nUse my refer code ${global.currentUser.referralCode} to signup with ${global.appInfo.appName} business community. Get free wallet points & exiting offers!.\n\nTo download the app - ${global.appInfo.androidAppLink}\n\nThanks.';
