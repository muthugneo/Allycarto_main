...
import 'package:gomeat/screens/new/home_vendor_list.dart';
...
class _BottomNavigationWidgetState extends BaseRouteState {
  ...
  List<IconData> _iconDataList = [MdiIcons.homeOutline, MdiIcons.store, MdiIcons.brightnessPercent, MdiIcons.accountOutline];
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        if(_bottomNavIndex == 1 || _bottomNavIndex == 2) {
  ...
  List<Widget> _screens() => [
        ...
        HomeVendorListScreen(a: widget.analytics, o: widget.observer),
        OfferListScreen(
          a: widget.analytics,
          o: widget.observer,
        ),
